...
""" 
Esta clase se encarga de categorizar los archivos descargados desde las bases de datos,
unifica los archivos y los asigna en la carpeta Data, además de identificar los duplicados y
realizar el respectivo guardado en la misma carpeta.
...
unify_results_from_files("Data/resultados_ACM.bib", "Data/resultados_ieee.bib", "Data/resultados_Sage.bib")